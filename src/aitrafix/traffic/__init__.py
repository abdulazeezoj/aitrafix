...
class TrafficController:
    def __init__(
        ...
        Args:
            sequence_length (int, optional): The length of the traffic state sequence.
            model_dir (str | None, optional): The directory to load the model from. Defaults to None.
            name (str | None, optional): The name of the model. Defaults to None.
        """
    ...
    def train(
        ...
        Args:
            ...
            seq_len (int, optional): The length of the traffic state sequence. Defaults to 5.
        ...
        _data: tuple[NDArray[Any], NDArray[Any]] = self._preprocess(data=data)
